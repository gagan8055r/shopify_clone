...
//
//     saveColor = () => {
//         const { primaryColors, selectedSection } = this.state;
//         const color = primaryColors[selectedSection];
//         const { storeId } = this.props;
//
//         const payload = {
//             color,
...
//                     {/*<button onClick={() => this.selectSection('home')}>Home</button>*/}
//                     {/*<button onClick={() => this.selectSection('catalog')}>Catalog</button>*/}
//                     {/*<button onClick={() => this.selectSection('contact')}>Contact</button>*/}
...
//                         color: styleObject.color,
//                         fontSize: styleObject['font-size'],
//                         backgroundColor: styleObject['background-color'],  // Capture background color
//                     };
//                     break;
//                 case 'image':
//                     componentData.src = component.attributes.src;
